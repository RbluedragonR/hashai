...
var twind = (function (e) {
  ...
  function T(e, t, r = p.u, n, a) {
    ...
    for (let s of e)
      for (let d of (function (e, t, r, n, a) {
        ...
        return s
          ? "string" == typeof s
            ? (({ r: n, p: r } = b(e, t, r, n)), O(T(M(s), t, r, n, e.i), e.n))
            : Array.isArray(s)
            ? s.map((e) => {
                var t, i;
                return o({ o: 0 }, e, {
  ...
  function _(e, t, r) {
    if ("[" == e[0] && "]" == e.slice(-1)) {
      if (((e = H(j(e.slice(1, -1), r.theme))), !t)) return e;
      if (
        !(
                          ...
                          if (e) {
                            ...
                            let u =
                              ...
                              (d =
                                ...
                                ? d
                                : i;
                            return s ? A(u, { opacityValue: j(s, a) }) : u;
                          }
                          let g = {};
              ...
              (function ({ disablePreflight: e } = {}) {
                return (function ({ colors: e, disablePreflight: t } = {}) {
                  return {
                    ...
                    finalize(e) {
                      var t;
                      return !e.r.some((e) => /^&::(before|after)$/.test(e)) ||
                        (null == (t = e.d) ? void 0 : t.includes("content:"))
                        ? e
                        : o({}, e, {
  ...
  return (
    (e.install = eF),
    (e.presetTailwind_colors = eC),
    (e.presetTailwind_defaultTheme = ez),
    e
  );

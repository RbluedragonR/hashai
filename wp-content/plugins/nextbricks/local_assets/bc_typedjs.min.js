    ...
    n = new ((function () {
      ...
      return (
        (s.typeHtmlChars = function (t, s, e) {
          ...
          var n,
            i = t.substring(s).charAt(0);
          if ("<" === i || "&" === i) {
            for (
              n = "<" === i ? ">" : ";";
              t.substring(s + 1).charAt(0) !== n && !(1 + ++s > t.length);
        ...
        (s.backSpaceHtmlChars = function (t, s, e) {
          ...
          if (">" === i || ";" === i) {
            for (
              n = ">" === i ? "<" : "&";
              t.substring(s - 1).charAt(0) !== n && !(--s < 0);
  ...
  return (function () {
    ...
    return (
      ...
      (s.typewrite = function (t, s) {
        var e = this;
        this.fadeOut &&
          "" == this.el.getAttribute(this.fadeOutClass) &&
          (this.el.removeAttribute(this.fadeOutClass),
          this.cursor && this.cursor.removeAttribute(this.fadeOutClass));
        ...
        !0 !== this.pause.status
          ? (this.timeout = setTimeout(function () {
              ...
              if ("`" === o.charAt(0)) {
                for (
                  ;
                  "`" !== t.substring(s + r).charAt(0) && !(s + ++r > t.length);

                );
                var u = t.substring(0, s),
                  p = t.substring(u.length + 1, s + r);
                (t = u + p + t.substring(s + r + 1)), r--;
              }
      ...
      (s.initFadeOut = function () {
        var t = this,
          s = this.fadeOutClass;
        return (
          this.el.setAttribute(s, ""),
          this.cursor && this.cursor.setAttribute(s, ""),
          setTimeout(function () {
            t.arrayPos++,
              t.replaceText(""),

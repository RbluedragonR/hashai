...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t =
        "undefined" != typeof globalThis ? globalThis : t || self).lgRotate =
        e());
})(this, function () {
  "use strict";
  var t = function () {
  ...
  return (function () {
    function n(e, i) {
      return (
        (this.core = e),
        (this.$LG = i),
        (this.settings = t(t({}, l), this.core.settings)),
        this
      );
    }
    return (
      ...
      (n.prototype.init = function () {
        ...
        this.settings.rotate &&
          ...
          this.core.LGel.on(e + ".rotate", function (e) {
            var i = e.detail.index;
            t.core.getSlideItem(i).find(".lg-img-rotate").get() ||
              (t.core
                .getSlideItem(i)
                .find(".lg-object")
                .first()
                .wrap("lg-img-rotate"),
              t.core
                .getSlideItem(t.core.index)
                .find(".lg-img-rotate")
                .css("transition-duration", t.settings.rotateSpeed + "ms"));
          }),
          this.core.outer
            .find("#lg-rotate-left")
            .first()
          ...
          this.core.LGel.on(i + ".rotate", function (e) {
            t.rotateValuesList[e.detail.index] ||
              (t.rotateValuesList[e.detail.index] = {
                rotate: 0,
                flipHorizontal: 1,
                flipVertical: 1,
      ...
      (n.prototype.getCurrentRotation = function (t) {
        ...
        if ("none" !== i) {
          ...
          if (o) {
            var r = Math.round(Math.atan2(o[1], o[0]) * (180 / Math.PI));
            return r < 0 ? r + 360 : r;
          }
        }
        return 0;
      ...
      (n.prototype.triggerEvents = function (t, e) {
        var i = this;
        setTimeout(function () {
          i.core.LGel.trigger(t, e);
        }, this.settings.rotateSpeed + 10);
      }),
      (n.prototype.isImageOrientationChanged = function () {
        var t = this.rotateValuesList[this.core.index],
          e = Math.abs(t.rotate) % 360 != 0,
          i = t.flipHorizontal < 0,
          o = t.flipVertical < 0;
        return e || i || o;
      }),

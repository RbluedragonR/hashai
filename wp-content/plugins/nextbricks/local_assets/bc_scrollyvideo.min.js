          ...
          for (e = 0; e < r.sample_sizes.length; e++) {
            ...
            (B.number = e),
              ...
              e > 0
                ...
                : (B.dts = 0),
              a
                ? (e >= w && (U++, w < 0 && (w = 0), (w += a.sample_counts[U])),
                  (B.cts = t.samples[e].dts + a.sample_offsets[U]))
                : (B.cts = B.dts),
              o
                ? (e == o.sample_numbers[S] - 1
                    ? ((B.is_sync = !0), S++)
  ...
  return class {
    ...
    transitionToTargetTime(t) {
      if (
        ...
        return this.video.pause(), void (this.transitioning = !1);

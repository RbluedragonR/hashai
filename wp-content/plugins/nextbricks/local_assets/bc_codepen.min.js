!(function (e) {
  ...
  (r.m = e),
    ...
    (r.p = "https://cpwebassets.codepen.io/assets/packs/"),
    r((r.s = 828));
})({
  828: function (e, t, r) {
    "use strict";
    ...
    var n = {
      ...
      _getType: function (e) {
        return this._HTML_TYPES.includes(e)
          ? "html"
          : this._CSS_TYPES.includes(e)
          ? "css"
          : this._JS_TYPES.includes(e)
          ? "js"
    ...
    var i = function e(t) {
      ...
      p = function (e) {
        ...
        var n = h(e),
          ...
          a = e["slug-hash"];
        return (
          void 0 !== e.token && (a += "/" + e.token),
          [t, o, r, a + "?" + n].join("/").replace(/\/\//g, "//")
        );
      },
      d = function (e) {
      ...
      v = function (e, t) {
        ...
        n.append(b(e)),
          "prefill" in e && ((r = g(e, t)), n.append(r)),
          S(t, n),
          r && r.submit();
      },
      _ = function (e, t) {
        ...
        for (var n in t)
          Object.prototype.hasOwnProperty.call(t, n) && r.setAttribute(n, t[n]);
        return r;
      },
      g = function (e, t) {
        var r = _("form", {
        ...
        for (var a in ((e.data = (function (e) {
          if (Object.hasOwn(e.dataset, "prefill")) {
            var t = {},
              r = e.dataset.prefill;
            for (var a in (r = JSON.parse(decodeURI(r) || "{}")))
              s.has(a) && (t[a] = r[a]);
            var i,
              u = o(e.querySelectorAll("[data-lang]"));
            try {
              for (u.s(); !(i = u.n()).done; ) {
                var l = i.value,
                  c = l.dataset.lang;
                l.dataset.optionsAutoprefixer &&
        ...
        e))
          "prefill" !== a &&
            r.append(_("input", { type: "hidden", name: a, value: e[a] }));
        return r;
      },
      b = function (e) {
        var t,
    ...
    function x(e) {
      ...
      for (
        var t = document.querySelectorAll(e), r = 0, n = t.length;
        r < n;
        r++
      ) {
        var o = t[r],

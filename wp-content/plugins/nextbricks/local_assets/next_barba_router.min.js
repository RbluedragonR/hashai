  ...
  return new /*#__PURE__*/ ((function () {
    ...
    return (
      (i.install = function (t, i) {
        ...
        (this.logger = new t.Logger(this.name)),
          ...
          o.forEach(function (t) {
            ...
            n.routeNames.indexOf(i) > -1
              ? console.warn(
                  "[@barba/router] Duplicated route name (" + i + ")"
                )
              : (n.routeNames.push(i),
                (n.routesByName[i] = { keys: o, path: e, regex: s }));
          }),
      ...
      (i.resolveRoutes = function (t) {
        var i = t.current,
          n = t.next;
        (i.route = i.url.href ? this.resolveUrl(i.url.href) : void 0),
          (n.route = n.url.href ? this.resolveUrl(n.url.href) : void 0);
      }),
      t
    );
  })())();

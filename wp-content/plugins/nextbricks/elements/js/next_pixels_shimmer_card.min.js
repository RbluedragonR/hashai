function next_pixels_shimmer_card() {
  class Pixel {
  ...
  document.querySelectorAll(".nb-pixels-shimmer-card").forEach((card) => {
    card.removeAttribute("data-flickering");
    PixelCanvas.register();
  });
}
document.addEventListener("DOMContentLoaded", function (t) {
  document.fonts.ready.then(function () {
    bricksIsFrontend && next_pixels_shimmer_card();
  });
});
